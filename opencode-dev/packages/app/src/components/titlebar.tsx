...
export function Titlebar() {
  ...
  return (
    ...
    >
      ...
      <div class="min-w-0 flex items-center justify-center pointer-events-none gap-3">
        <div class="pointer-events-auto flex items-center gap-2 shrink-0">
          <div class="w-5 h-5 rounded bg-[#84cc16] flex items-center justify-center shadow-[0_0_10px_rgba(132,204,22,0.2)]">
            <svg class="w-3.5 h-3.5 text-black" viewBox="0 0 24 24" fill="currentColor" stroke="none">
              <path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z" />
            </svg>
          </div>
          <span class="font-bold text-sm tracking-tight text-text-strong">TISS <span class="text-[#84cc16]">ARENA</span></span>
        </div>
