...
export default function Page() {
  ...
  const [selectedVideoPath, setSelectedVideoPath] = createSignal<string | undefined>()
    ...
    <div class="relative bg-background-base size-full overflow-hidden flex flex-col">
      ...
      <div class="flex-1 min-h-0 flex flex-col md:flex-row">
        ...
        <Show when={isDesktop() && layout.fileTree.opened()}>
          <aside class="shrink-0 h-full border-l border-border-weak-base" style={{ width: `${layout.fileTree.width()}px` }}>
            <div class="h-full flex flex-col overflow-hidden">
              <Tabs
                variant="pill"
                value={fileTreeTab()}
                onChange={setFileTreeTab}
                class="h-full"
              >
                <Tabs.List>
